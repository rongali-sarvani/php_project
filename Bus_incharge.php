...
<html>
    ...
    <body>
        <header>
        <h2><b>BUS_INCHARGE</b><br>Welcome to <?php  echo $_SESSION["uname"];  ?></h2>
        <form action="Bus_incharge.php" method="post">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $query = "SELECT * FROM student_login_details where role='student' and bus_name='$busname' ";
                                        ...
                                        foreach($query_run as $student)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="studcode.php" method="POST" class="d-inline">
